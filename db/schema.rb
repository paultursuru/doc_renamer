...
ActiveRecord::Schema[8.1].define(version: 2026_06_27_103745) do
  ...
  create_table "rename_batches", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "finished_at"
    t.uuid "good_job_batch_id"
    t.string "session_token", null: false
    t.datetime "updated_at", null: false
    t.index ["good_job_batch_id"], name: "index_rename_batches_on_good_job_batch_id", unique: true
    t.index ["session_token"], name: "index_rename_batches_on_session_token"
  end

  create_table "rename_items", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.datetime "created_at", null: false
    t.string "ext", default: "", null: false
    t.text "message"
    t.string "original", null: false
    t.string "proposed"
    t.uuid "rename_batch_id", null: false
    t.string "state", default: "pending", null: false
    t.string "status"
    t.string "stored_id", null: false
    t.datetime "updated_at", null: false
    t.index ["rename_batch_id", "state"], name: "index_rename_items_on_rename_batch_id_and_state"
    t.index ["rename_batch_id"], name: "index_rename_items_on_rename_batch_id"
  end

  add_foreign_key "rename_items", "rename_batches"
end
